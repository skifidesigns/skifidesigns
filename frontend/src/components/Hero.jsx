...
export const Hero = () => {
  ...
  return (
    <section
      ref={heroRef}
      className="relative flex items-center justify-center overflow-hidden pt-24 pb-12 sm:pt-32 sm:pb-20"
    >
        ...
        >
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 sm:px-4 sm:py-2 skifi-glass-pill rounded-full">
              ...
              <span className="text-[11px] sm:text-xs font-medium text-foreground/80 whitespace-nowrap tracking-wide">
          ...
          >
            ...
            <button
              ...
              className="skifi-btn-ghost group inline-flex items-center justify-center gap-2 w-full sm:w-auto px-6 py-3 sm:px-7 sm:py-3.5 rounded-xl text-sm sm:text-base font-semibold text-foreground"
            >
          ...
          <motion.div
            ...
            className="pt-4 sm:pt-8 max-w-4xl mx-auto"
          >
            <div
              onMouseMove={handleMouseMove}
              className="skifi-glass skifi-spotlight rounded-2xl p-4 sm:p-6 md:p-8"
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
                {stats.map((s, i) => (
                  ...
                  >
                    <div className="text-xl sm:text-3xl md:text-4xl font-bold text-foreground mb-1 sm:mb-1.5 tracking-tight">
                      {s.value}
                    </div>
                    <div className="text-[9px] sm:text-[11px] md:text-xs text-muted-foreground uppercase tracking-[0.14em] leading-tight">
                      {s.label}
                    </div>
                  </motion.div>
                ))}
          ...
          <motion.div
            ...
            className="pt-4 sm:pt-10 flex justify-center"
          >
