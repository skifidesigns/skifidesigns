...
async def dynamic_sitemap():
    ...
    urls = [
        ...
        (f"{base}/ai-lab", today, "0.8", "weekly"),
        (f"{base}/ai-lab/deck-review", today, "0.7", "monthly"),
        (f"{base}/ai-lab/template-generator", today, "0.7", "monthly"),
        # Service landing pages (SEO targets - high-converting Fiverr keywords)
        (f"{base}/services/powerpoint-design", today, "0.9", "weekly"),
